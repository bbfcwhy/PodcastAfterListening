...
export function AdminSidebar() {
    ...
    return (
        <aside className="w-full md:w-48 border-r border-border-subtle bg-canvas p-4" role="complementary">
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            ...
                            >
                                <Button
                                    variant="ghost"
                                    className={`w-full justify-start hover:bg-hover ${active ? "bg-selected text-text-primary" : "text-text-secondary"
                                        }`}
                                    tabIndex={-1}
                                >
